...
CREATE TABLE grants (id BIGINT AUTO_INCREMENT, body LONGTEXT, user_id BIGINT, organization_id BIGINT, INDEX organization_id_idx (organization_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE grants ADD CONSTRAINT grants_organization_id_organizations_id FOREIGN KEY (organization_id) REFERENCES organizations(id);
