...
CREATE TABLE grants (id BIGINT AUTO_INCREMENT, body LONGTEXT, collector_id BIGINT, reviewer_id BIGINT, organization_id BIGINT, INDEX reviewer_id_idx (reviewer_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE member (id BIGINT AUTO_INCREMENT, name VARCHAR(50), email VARCHAR(50), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE organizations (id BIGINT AUTO_INCREMENT, engname VARCHAR(255), chnname VARCHAR(255), reviewercomment LONGTEXT, collector_id BIGINT, reviewer_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX reviewer_id_idx (reviewer_id), PRIMARY KEY(id)) ENGINE = INNODB;
