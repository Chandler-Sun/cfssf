...
CREATE TABLE organizations (id BIGINT AUTO_INCREMENT, name VARCHAR(255), reviewercomment LONGTEXT, collector_id BIGINT, reviewer_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX reviewer_id_idx (reviewer_id), PRIMARY KEY(id)) ENGINE = INNODB;
