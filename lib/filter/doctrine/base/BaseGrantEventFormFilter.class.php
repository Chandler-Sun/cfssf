...
/**
 * GrantEvent filter form base class.
 *
 * @package    cfssf
 * @subpackage filter
 ...
 */
abstract class BaseGrantEventFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('grant_event_filters[%s]');
