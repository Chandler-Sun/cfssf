...
/**
 * GrantEvent form base class.
 *
 * @method GrantEvent getObject() Returns the current form's model object
 *
 * @package    cfssf
 * @subpackage form
 ...
 */
abstract class BaseGrantEventForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('grant_event[%s]');
