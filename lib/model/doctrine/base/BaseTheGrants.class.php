 ...
 * @method TheGrants    setComment()         Sets the current record's "comment" value
 * @method TheGrants    setCollectorId()     Sets the current record's "collector_id" value
 * @method TheGrants    setReviewerId()      Sets the current record's "reviewer_id" value
 * @method TheGrants    setOrganizationId()  Sets the current record's "organization_id" value
 * @method TheGrants    setOrganization()    Sets the current record's "Organization" value
 * @method TheGrants    setMember()          Sets the current record's "Member" value
 * 
 * @package    cfssf
 * @subpackage model
 ...
 */
abstract class BaseTheGrants extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('the_grants');
